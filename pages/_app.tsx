...
function MyApp({ Component, pageProps }: AppProps) {
    ...
    return <Fragment>
        <Head>
			...
			<script async src="https://analytics.huy.rocks/tracker.js" data-ackee-server="https://analytics.huy.rocks" data-ackee-domain-id="ebd2a693-bfc3-4853-85f0-49d6e1db6fa4"></script>
