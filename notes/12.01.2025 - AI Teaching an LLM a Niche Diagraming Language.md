...
componentDiagram
autonumber
title Platform Component Diagram
GamePlatform: GamePlatform
User: User
Game: Game
GamePlatform-->>User: buy
User-->>GamePlatform: sell
GamePlatform: manage
Game: store
```
...
**P/S:** If you want to try AI-assisted diagramming yourself, check out my project, [ChatUML](https://chatuml.com). It's designed to turn text into diagrams instantly. You can grab 60% off right now using the code **PINTORA**!
